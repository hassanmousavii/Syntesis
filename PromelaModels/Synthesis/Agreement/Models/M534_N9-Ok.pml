#define N 9 // ring Size
#define dec(i) ((i+N-1)%N)
#define inc(i) ((i+1)%N)
#define r(i)  (x[i] != x[dec(i)] && y[i] != y[dec(i)] && z[i] != z[dec(i)])
#define q(i) (x[i] ==x[dec(i)] && y[i] == y[dec(i)] && z[i] == z[dec(i)])
#define R (r(0) && r(1) && r(2) && r(3) && r(4) && r(5) && r(6) && r(7) && r(8))
#define Q (q(0) && q(1) && q(2) && q(3) && q(4) && q(5) && q(6) && q(7) && q(8))
byte x[N]={1,3,1,3,2,0,4,2,3};
byte y[N]={1,0,2,0,2,0,2,0,2};
byte z[N]={3,0,1,2,1,0,2,1,0};
active [N] proctype p(){
short i = _pid;
 do
